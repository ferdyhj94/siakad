...
@section('titlePageAdmin','Daftar Guru - Sistem Informasi Akademik')
@section('content')
...
@endif
              ...
              <a href="{{route('tambahGuru')}}" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
          </div>
               ...
               <tr>
                ...
                <td><a href="detail-guru/{{$data->id}}" class="btn btn-primary">Lihat</a></td>
               </tr>
               @empty
               <tr>

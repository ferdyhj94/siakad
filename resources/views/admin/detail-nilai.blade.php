...
@endif
              ...
              <a href="{{route('admin.inputNilai')}}" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
              <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Download Data<span class="caret"></span>
              </button>
              <ul class="dropdown-menu">
                <li><a href="/admin/download-nilai/<?php echo $id_daftar_nilai->id; ?>/xls"><button class="btn btn-success">Download Excel sebagai xls</button></a></li>
                <li><a href="/admin/download-nilai/<?php echo $id_daftar_nilai->id; ?>/xlsx"><button class="btn btn-success">Download Excel sebagai xlsx</button></a></li>
                <li><a href="/admin/download-nilai/<?php echo $id_daftar_nilai->id; ?>/csv"><button class="btn btn-success">Download sebagai CSV</button></a></li>                
                <li><a href="/admin/download-nilai-pdf/<?php echo $id_daftar_nilai->id; ?>"><button class="btn btn-success">Download sebagai PDF</button></a></li>
                <!-- downloadNilaiPDF? -->
              </ul>
              </div>
          </div>

...
<div class="alert alert-success" role="alert">
  ...
  @endif       
              ...
              <a href="{{url('admin/tambah-materi')}}" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
          </div>
               ...
               <tr>
                ...
                <td><a href="/admin/materi/daftar-materi/{{$data->id}}" class="btn btn-primary">Detail</a></td>
               </tr>
               @empty
               <tr>

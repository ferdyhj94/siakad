  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{set_active('daftar-pengguna')}}"><a href="{{url('daftar-pengguna')}}"><i class="fa fa-circle-o"></i> <span>Pengguna</span></a></li>
          </ul>
        </li>

        <li class="{{set_active('guru/materi')}}"><a href="{{url('guru/materi')}}"><i class="fa fa-book"></i> <span>Materi</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
        <li class="{{set_active('guru/rekap-rapor')}}"><a href="{{url('guru/rekap-rapor')}}"><i class="fa fa-circle-o"></i> <span>Rapor Siswa</span></a></li>
          </ul>
        </li>
